...
const inputs = [
  createInputValidator("prénom", firstNameEl, [
    validators.required,
    validators.needTwoChars,
  ]),
  createInputValidator("nom", lastNameEl, [
    validators.required,
    validators.needTwoChars,
  ]),
  createInputValidator("email", emailEl, [
    validators.required,
    validators.email,
  ]),
  createInputValidator("date de naissance", birthDateEl, [validators.required]),
  createInputValidator("tournois", quantityEl, [
    validators.required,
    validators.isNum,
  ]),
